...
mod tests {
    ...
    fn track_union_nested_dict() {
        ...
        let dctfield = Field::new_dict("dict", array.data_type().clone(), false, false);
    ...
    fn test_decimal128_alignment16_is_sufficient() {
        ...
        for num_cols in [1, 2, 3, 17, 50, 73, 99] {
            ...
            let decoder =
                FileDecoder::new(buffer[trailer_start - footer_len..trailer_start].to_vec(), Default::default(), footer.version()).with_require_alignment(true);
